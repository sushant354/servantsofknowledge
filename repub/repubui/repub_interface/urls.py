...
urlpatterns = [
    ...
    path('job/<uuid:job_id>/edit/', jobs.edit_job, name='edit_job'),
    ...
    path('job/<uuid:job_id>/submit-for-correction/', review.submit_for_correction, name='submit_for_correction'),
    path('job/<uuid:job_id>/submit-correction-zip/', review.submit_correction_zip, name='submit_correction_zip'),
    path('job/<uuid:job_id>/download-corrections/', review.download_corrections, name='download_corrections'),
